...
export default function ChatInterface() {
  ...
  return (
    <div className="fixed bottom-6 right-6 w-96 bg-white  rounded-2xl shadow-2xl flex flex-col h-[500px]">
      ...
      <form onSubmit={sendMessage} className="p-4 border-t border-amber-300">
        <input 
          className="w-full p-2 shadow rounded-lg focus:ring-brand-primary outline-none" 
          value={input} 
